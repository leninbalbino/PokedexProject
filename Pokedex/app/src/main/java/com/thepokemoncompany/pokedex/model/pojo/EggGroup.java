...
public class EggGroup implements Serializable, Parcelable
{
    ...
    @Expose
    private String url;
    public final static Parcelable.Creator<EggGroup> CREATOR = new Creator<EggGroup>() {
    ...
    ;
    private final static long serialVersionUID = 40187798896931685L;
